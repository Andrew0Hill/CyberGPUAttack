...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        CLPlatform plt_arr[] = CLPlatform.listCLPlatforms();
        ...
        try{
            ...
            CLDevice device_arr[] = context.getDevices();

            // Print list of all OpenCL devices available on this CLPlatform
            for (int i = 0; i < device_arr.length; ++i){
                System.out.println(device_arr[i]);
            }
            ...
            CLProgram program = context.createProgram(Main.class.getResourceAsStream("VectorAdd.cl")).build();
